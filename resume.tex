...
Sharing is then done on a 'Bubble' level, where information is grouped by the user into a single sharable package.
...
\begin{itemize}
  ...
  \item
    Lightweight: The containers that provide the security for the Bubbles system should have minimal performance impact
\end{itemize}
...
\begin{itemize} 
  ...
  \item
    libholonomic: holonomic (omni-wheel) drive and localisation library in C
  \item
